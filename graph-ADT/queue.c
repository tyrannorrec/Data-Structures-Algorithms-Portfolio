...
int enqueue(int item) {
    ...
    int insertSuccess = insertRear(myQueueList, item);    
...
int dequeue() {
    ...
    int frontOfQueue = myQueueList->head->data;
    int deleteSuccess = deleteFront(myQueueList);   
    return frontOfQueue;
...
int queueFull() {
    ...
    if (listLength(myQueueList) == FULLQUEUE) {
        return 1;
    } // IF
...
// ---------------------------------------------------------- 
//  Function `printQueueMenu` prints the menu choices in the queue ADT.
// ---------------------------------------------------------- 
...
// ---------------------------------------------------------- 
//  Function `GetUserQueueChoice` gets input from user and returns integer.
// ---------------------------------------------------------- 

int getUserQueueChoice() {
    int tempChoice = 0;
    ...
    printf("\n");
    return tempChoice;
} // Function `GetUserQueueChoice`

// ---------------------------------------------------------- 
//  Function `executeMenu` displays menu and implements choice.
// ---------------------------------------------------------- 

int executeQueueMenu() {
    int tempChoice = 0;
    int myNum = 0;
    int tempNum = 0;
    char myChar = '0';

    tempChoice = getUserQueueChoice();
